...
function Doc_Danh_sach_Thanh_ly_Sach() {
    var Du_lieu = {}
    var Xu_ly_HTTP = new XMLHttpRequest()
    var Tham_so = `Ma_so_Xu_ly=Doc_Danh_sach_Thanh_ly_Sach`
    var Dia_chi_Xu_ly = `${Dia_chi_Dich_vu}?${Tham_so}`
    Xu_ly_HTTP.open("POST", Dia_chi_Xu_ly, false)
    Xu_ly_HTTP.send("")
    var Chuoi_JSON = Xu_ly_HTTP.responseText
...
function Ghi_Sach_Moi(Dien_thoai) {
    var Du_lieu = {}
    var Xu_ly_HTTP = new XMLHttpRequest()
...
function Ghi_Thanh_ly_Sach(Danh_sach) {
    var Kq = ""
    var Xu_ly_HTTP = new XMLHttpRequest()
    var Tham_so = `Ma_so_Xu_ly=Thanh_ly_Sach`
    var Dia_chi_Xu_ly = `${Dia_chi_Dich_vu}?${Tham_so}`
    Xu_ly_HTTP.open("POST", Dia_chi_Xu_ly, false)
    var Chuoi_Goi = JSON.stringify(Danh_sach)
    Xu_ly_HTTP.send(Chuoi_Goi)
...
function Tao_The_hien_Them_Sach(Th_Cha) {
    var Chuoi_HTML = `
        ...
        <div class="form-group">
            <label for="Th_Nhom_Sach">Nhóm Điện thoại</label>
...
function Tao_The_hien_Sach(Dien_thoai, Th_Cha) {
